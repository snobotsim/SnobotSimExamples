...
{
public:
    SnobotGearBoss(std::shared_ptr<frc::DoubleSolenoid> aGearSolenoid,
...
protected:
    std::shared_ptr<frc::DoubleSolenoid> mGearSolenoid;
    std::shared_ptr<IOperatorJoystick> mOperatorJoystick;
    std::shared_ptr<ILogger> mLogger;

    bool mGearIsUp;

    static const frc::DoubleSolenoid::Value sGEAR_DOWN_VALUE;
    static const frc::DoubleSolenoid::Value sGEAR_UP_VALUE;
};
