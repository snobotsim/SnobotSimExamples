...
{
public:
    SnobotClimber(const std::shared_ptr<frc::SpeedController>& aClimbingMotor, const std::shared_ptr<IOperatorJoystick>& aJoystick, const std::shared_ptr<ILogger>& aLogger);
...
protected:
    ...
    std::shared_ptr<frc::SpeedController> mClimbingMotor;
