...
{
public:
    SnobotPositioner(const std::shared_ptr<IDrivetrain>& aDriveTrain, const std::shared_ptr<frc::Gyro>& aGyro, const std::shared_ptr<ILogger>& aLogger);
