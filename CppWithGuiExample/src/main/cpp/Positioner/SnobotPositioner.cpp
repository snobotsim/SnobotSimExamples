...
{
    frc::SmartDashboard::PutNumber(SmartDashboardNames::sX_POSITION, mXPosition);
    frc::SmartDashboard::PutNumber(SmartDashboardNames::sY_POSITION, mYPosition);
    frc::SmartDashboard::PutNumber(SmartDashboardNames::sORIENTATION, (mOrientation));
    frc::SmartDashboard::PutNumber(SmartDashboardNames::sSPEED, mSpeed);
}
